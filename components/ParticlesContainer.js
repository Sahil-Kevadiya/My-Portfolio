...
const ParticlesContainer = () => {
  //init
  const particalesInit = useCallback(async (engine) => {
  ...
  return(
    <Particles className='w-full h-full absolute translate-z-0'
     id='tsparticles' init={particalesInit} loaded={particalesloaded} 
     options={{
      fullScreen: {enable: false}, background: {
        color: {
          value: ''
        },
      },
      fpsLimit: 1000, interactivity: {
        events: {
