...
const Home = () => {
  ...
  <div className="bg-primary/60 h-full">
    {/*text*/}
    <div className="w-full h-full bg-gradient-to-r from-primary/10 via-block/30 to-black/30">
      <div className="text-center flex flex-col justify-center xl:pt-40 xl:text-left h-full container mx-auto">
        {/*title*/}
        <motion.h1 variants={fadeIn('down',0.2)} 
        initial='hidden' animate='show' exit='hidden' 
        className="h2">
          Hello,I am <br /> <span className="text-accent"> Sahil Kevadiya</span>
        </motion.h1>
        {/*subtitle*/}
        <motion.p variants={fadeIn('down',0.3)} 
        initial='hidden' animate='show' exit='hidden' 
        className="max-w-sm xl:max-w-xl mx-auto xl:mx-0 mb-10 xl:mb-10">
          Hello! I&apos;m&apos; Sahil Kevadiya, final year B.Tech student specializing in Artificial Intelligence. 
          Currently residing in Surat. If you have a
          ny questions or topics you&apos;d&apos; like to discuss, feel free to let me know!
        </motion.p>
        {/* btn*/}
